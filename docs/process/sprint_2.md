...
| **5**    | Sviluppo validazione piazzamento                                 | Elisa        | 5              | Implementazione per il piazzamento dei dischi sulla PersonalBoard  con integrazione delle regole di validazione legate agli AnimalCubes | 5        | 5        | 5        | 3        | 3        | 3        | 3        |
| **6**    | Gestione turni e loop                                            | Elisa        | 8              | Implementazione del flusso di gioco: gestione dei turni, ordine dei giocatori e ciclo principale della partita                          | 5        | 5        | 4        | 3        | 3        | 3        | 2        |
