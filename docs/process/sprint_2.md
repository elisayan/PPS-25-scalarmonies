...
| **5**    | Sviluppo validazione piazzamento                                 | Elisa        | 5              | Implementazione per il piazzamento dei dischi sulla PersonalBoard  con integrazione delle regole di validazione legate agli AnimalCubes | 0        | 0        | 0        | 0        | 3        | 5        | 5        |
| **6**    | Gestione turni e loop                                            | Elisa        | 8              | Implementazione del flusso di gioco: gestione dei turni, ordine dei giocatori e ciclo principale della partita                          | 3        | 3        | 1        | 5        | 5        | 6        | 5        |
